...
function ProductizationPageContent() {
  const { currentUser, deepWorkDefinitions, setDeepWorkDefinitions, productizationPlans, setProductizationPlans, deepWorkTopicMetadata, updateTopic, deleteTopic } = useAuth();
                        ...
                        <div className="flex justify-between items-start gap-4">
                            ...
                            <div className="flex items-center">
                                {currentUser?.username === 'Lonewolf' && topic === 'Life OS' && (
                                    <Button size="sm" onClick={() => handlePublishReleases(topic)} className="flex-shrink-0 h-8 mr-1">
                                        Publish
                                    </Button>
                                )}
